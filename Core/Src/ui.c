...
void draw_bg()
{
  ...
  //sub sub window
  LCD_DrawRectangle(165, 110, 235, 180);
  LCD_ShowString(182,  85, 200, 16, 16, (unsigned char*)"FIRST");
  LCD_ShowString(175, 185, 200, 16, 16, (unsigned char*)"SECOND");
  LCD_ShowString(177, 230, 200, 16, 16, (unsigned char*)"SCORE:");
  LCD_ShowString(172, 250, 200, 16, 16, (unsigned char*)"   0");
  LCD_ShowString(177, 270, 200, 16, 16, (unsigned char*)"LEVEL:");
  LCD_ShowString(172, 290, 200, 16, 16, (unsigned char*)"   0");
  LCD_Fill(10, 10, 160, 310, BLACK);
  LCD_Fill(166, 11, 234, 79, BLACK);
  LCD_Fill(166, 111, 234, 179, BLACK);
}
...
void update_score(uint16_t score)
{
  ...
  LCD_ShowString(170, 290, 200, 16, 16, (uint8_t *)str_level);
}
